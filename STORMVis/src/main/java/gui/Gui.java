...
public class Gui extends JFrame implements TableModelListener,PropertyChangeListener,ThreadCompleteListener {
	...
	public Gui() {
		...
		verticalBox_3.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Acquisition Parameters", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		windowsizePSFRenderingField.getDocument().addDocumentListener(new MyDocumentListener(windowsizePSFRenderingField));
